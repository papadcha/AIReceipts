...
προσοχή σε πραγματικές περιπτώσεις χρήσης -- βλ. DESKTOP_APP_PLAN.md στο
αρχικό project."""
...
class CompanyPage(QWizardPage):
    ...
    θεωρηθεί αυτόματα η προεπιλεγμένη εταιρεία χωρίς επιβεβαίωση, ενώ η
    καρτέλα αφορούσε διαφορετική εταιρεία."""
...
class LedgerPage(QWizardPage):
    """Προεπισκόπηση των κινήσεων που διάβασε ο parser -- ένα bug σε
    πραγματική καρτέλα (0 κινήσεις αναγνωρίστηκαν, λάθος σύνολο αντί του
    σωστού) περνούσε απαρατήρητο χωρίς αυτό το βήμα."""
